...
public class JwtTokenProvider {
    ...
    public String generateJwtToken(UserPrincipal userPrincipal) {
        ...
        return JWT.create().withIssuer(WWYP_LLC)
                .withAudience(WWYP_ADMINISTRATION)
    ...
    private JWTVerifier getJwtVerifier() {
        ...
        try {
            ...
            verifier = JWT.require(algorithm).withIssuer(WWYP_LLC).build();
